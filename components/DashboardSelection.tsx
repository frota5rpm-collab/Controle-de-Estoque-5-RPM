    ...
    <div className="min-h-screen bg-[#958458] flex flex-col items-center justify-center p-4 font-sans relative">
      ...
      <div className="w-full max-w-6xl mt-12 md:mt-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <button onClick={() => onSelectModule('STOCK')} className="group bg-[#fdfbf7] p-6 rounded-xl shadow-2xl border-t-8 border-[#3E3223] hover:scale-[1.02] transition-all flex flex-col items-center text-center cursor-pointer">
          ...
          <button onClick={() => onSelectModule('SCHEDULE')} className="group bg-[#fdfbf7] p-6 rounded-xl shadow-2xl border-t-8 border-[#C5A059] hover:scale-[1.02] transition-all flex flex-col items-center text-center cursor-pointer">
          ...
          <button onClick={() => onSelectModule('SUBSTITUTION')} className="group bg-[#fdfbf7] p-6 rounded-xl shadow-2xl border-t-8 border-[#556B2F] hover:scale-[1.02] transition-all flex flex-col items-center text-center cursor-pointer">
          ...
          <button onClick={() => onSelectModule('PAV')} className="group bg-[#fdfbf7] p-6 rounded-xl shadow-2xl border-t-8 border-[#3E3223] hover:scale-[1.02] transition-all flex flex-col items-center text-center cursor-pointer">
            <div className="bg-[#3E3223]/10 p-6 rounded-full mb-6 group-hover:bg-[#3E3223]/20 transition-colors">
